...
class Player(GameSprite):
    ...
    def heal(self, amount):
        ...
        for i in range(amount):
            heart = HpImage(self.health_list[-1].rect.x - 60)
            self.health_list.append(heart)
...
class Enemy(GameSprite):
    ...
    def update(self):
        ...
        if self.rect.y >= HEIGHT:
            ...
            text_lost = font_interface.render("Прoпyшeно: "+ str(lost), True, (255, 255, 255))
            self.respawn(2)
...
class CommonUfo(Enemy):
    def __init__(self):
        ...
        self.hp = 2
        self.shield_bonus_shance = 5

    def death(self):
        global text_score, score
        self.respawn(2)
        score += 1
        text_score = font_interface.render("Paxyнок: " + str(score), True, (255, 255, 255))
...
class BossUfo(Enemy):
    ...
    def death(self):
        ...
        player.heal(1)
        boss_access = True
        text_score = font_interface.render("PaxyнOK: " + str(score), True, (255, 255, 255))
...
class Bonus (GameSprite):
    ...
    def catch(self, sprite, durability):
        if self.effect == "shield":
            sprite.get_shield (durability)
        self.kill()
...
text_lost = font_interface.render("Пponyшено: " + str(lost), True, (255, 255, 255))
text_score = font_interface.render("Рахунок: " + str(score), True, (255, 255, 255))

text_win = font_finish.render("Пepeмora!", True, (50, 200, 55))
text_lose = font_finish.render("Пpoгpaв!", True, (200, 55, 55))
...
while game:
    ...
    if not finish:
        ...
        crash_list_asteroids = sprite.spritecollide(player, ufo_group, False)
        ...
        boss_hit_list = sprite.groupcollide(boss_group, bullets_group, False, True)
